...
namespace {
	 ...
	 * @property array{url: string, width: int, height: int, sizes?: array<string, array{url: string, width: int, height: int}>}|array{}  $onesearch_thumbnail Thumbnail data from Algolia record.
	 */
	class WP_Post {
	}
}
